...
function hrsMenu() {
    ...
    for (i = 21; i <= hours;i++) {
        select.options[select.options.length] = new Option(i < 10 ? "21"  : i, i);
    }
}
...
document.getElementById("mySelectp").addEventListener("change", getSrc);
